 ...
 */
System.register(['es6-symbol', './method-proxy', 'lodash', '../utils/util', './inject'], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var es6_symbol_1, method_proxy_1, _, util_1, inject_1;
    ...
    return {
        ...
        execute: function() {
             ...
             * di時に使用された名前を格納するキー
             */
            exports_1("INJECTION_NAME_SYMBOL", INJECTION_NAME_SYMBOL = es6_symbol_1.default('__injectionname__'));
            /**
             * シングルトンオブジェクトのインスタンスを格納するキー
             */
            SINGLETON_KEY = es6_symbol_1.default('__instance__');
            /**
             * インターセプタ適用済みの印
             */
            PROXIED_MARD = es6_symbol_1.default('__proxied__');
            /**
             * 依存性の定義
             */
            Injections = (function () {
